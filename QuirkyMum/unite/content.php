...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		...
		<span class="comments-link"><i class="fa fa-comment"></i><?php comments_popup_link( __( 'Leave a comment', 'unite' ), __( 'One Comment so far', 'unite' ), __( '% Comments so far', 'unite' ) ); ?></span>
		<?php endif; ?>

		<?php edit_post_link( __( 'Edit', 'unite' ), '<i class="fa fa-pencil-square-o"></i><span class="edit-link">', '</span>' ); ?>
		<span class="menu-social-footer">Share this: 
			<?php wp_nav_menu( array( 'theme_location' => 'footer-social', 'menu_class' => 'social-menu' ) ); ?>
		</span>
	</footer><!-- .entry-meta -->
